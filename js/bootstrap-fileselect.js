    ...
    var Fileselect = function (fileInput, options) {
        ...
        this.translations = {
            ...
            'fr': {
                'browse': 'Parcourir',
                'rules': {
                    'numberOfFiles': 'Le nombre de fichiers uploadable est limité à [num] fichier(s)',
                    'fileExtensions': 'Les fichiers sont limités aux extensions: [ext]',
                    'fileSize': 'La taille du fichier est limitée à [size]',
                }
            }
        };
        this.init();
